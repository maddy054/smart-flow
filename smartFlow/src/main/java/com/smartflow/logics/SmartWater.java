...
public class SmartWater {
	...
	public void checkPassword(String userName,String password) throws OwnException {
		connector.checkPassword(userName, password);
	}
	...
	public String getRecentSensorData(SensorType sensor,int locationId) {
		return connector.getRecentData(sensor, locationId);
